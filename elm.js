...
Elm.Main.make = function (_elm) {
   ...
   var Hat = {ctor: "Hat"};
   var Cat = {ctor: "Cat"};
   var picture = $Signal.mailbox(Cat);
   var cat = A2($Graphics$Input.clickable,A2($Signal.message,picture.address,Cat),A3($Graphics$Element.image,30,30,"/cat.jpg"));
   var input = function () {
   ...
   var view = F2(function (_p0,mario) {
      ...
      var src = A2($Basics._op["++"],"/imgs/mario/",A2($Basics._op["++"],verb,A2($Basics._op["++"],"/",A2($Basics._op["++"],dir,".gif"))));
